...
export const en = {
  ...
  stemReview: {
    ...
    play: "Play it",
    sources: "Where each part went",
    sourcesHelp:
      "The separator's six heads, on their own. Cut with the stems and thrown away on the next save — they are here for the moment a part is missing and you want to know where it ended up. A plucked upright often turns up under guitar.",
  ...
  library: {
    ...
    stop: "Stop",
    extractedNone: "The opening. No solo marked on it yet.",
    extractedOne: "The opening, and one solo marked on it.",
    extractedMany: "The opening, and {n} solos marked on it.",
    tabOpening: "The opening",
    overviewSplit: "{ok} playable · {ruled} ruled on",
    overviewUnsplit: "not separated yet",
    tabSolo: "Solo {n}",
    openingHelp:
      "The top of the tune, where the theme is stated and nobody is soloing yet. The marker is where a round opens.",
    soloHelp:
      "Where this solo comes in. The marker is where a round opens on the hard level.",
    noSoloCut: "This entry has no solo cut. Mark it again to give it one.",
    soloistPlays: "Credited on {role}, which is the head lifted out for this cut.",
    deleteSolo: "Delete this solo",
    metadata: "Metadata",
